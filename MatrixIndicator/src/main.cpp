...
void setup() {
  ...
  matrix.drawLine(5, 0, W-1, 0, matrix.Color(255,   0,   0)); // red
  matrix.drawLine(5, 1, W-1, 1, matrix.Color(255, 127,   0)); // orange
  matrix.drawLine(5, 2, W-1, 2, matrix.Color(255, 255,   0)); // yellow
  matrix.drawLine(5, 3, W-1, 3, matrix.Color(0,   255,   0)); // green
  matrix.drawLine(5, 4, W-1, 4, matrix.Color(0,     0, 255)); // blue
  matrix.drawLine(5, 5, W-1, 5, matrix.Color(75,    0, 130)); // indigo
  matrix.drawLine(5, 6, W-1, 6, matrix.Color(148,    0, 211)); // violet
